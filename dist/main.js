...
import { analyzeResume, enhanceBulletPoint, checkATSCompatibility } from './ai-utils.js';
...
function renderExperienceList() {
    ...
    list.querySelectorAll('.add-h').forEach(btn => {
        btn.addEventListener('click', (e) => {
            const idx = parseInt(e.currentTarget.getAttribute('data-index'));
            if (!state.resumeData.experience[idx].highlights)
                state.resumeData.experience[idx].highlights = [];
